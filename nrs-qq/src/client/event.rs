...
macro_rules! define_message {
    (
        ...
        #[derivative(Debug)]
        pub struct $s_name<P:crate::provider::ClientProvider>
        {
            #[derivative(Debug = "ignore")]
            pub client:alloc::sync::Arc<$crate::Client<P>>,
...
impl<P> GroupMessageEvent<P> where P: ClientProvider {}
// #[derive(Clone, derivative::Derivative)]
// #[derivative(Debug)]
...
impl<P> GroupRequestEvent<P> where P: ClientProvider {}
// #[derive(Clone, derivative::Derivative)]
// #[derivative(Debug)]
...
impl<P> FriendRequestEvent<P> where P: ClientProvider {}
// #[derive(Clone, derivative::Derivative)]
// #[derivative(Debug)]
...
impl<P> NewMemberEvent<P> where P: ClientProvider {}
// #[derive(Clone, derivative::Derivative)]
// #[derivative(Debug)]
